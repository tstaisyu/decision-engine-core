...
import {
  ...
  resetDefinitionChange
} from "../lib/viewerAuthoringWorkflow.js";
...
function DefinitionPanel({
  ...
  function resetChange(resetType, target) {
    if (!selectedConfig || !baseSelectedConfig) {
      return;
    }

    onConfigChange(resetDefinitionChange(selectedConfig, baseSelectedConfig, resetType, target));
  }
  ...
  function resetAllChanges() {
    ...
    onConfigChange(resetAllDefinitionChanges(baseSelectedConfig));
  }

  const changes = buildDefinitionChanges(selectedConfig, baseSelectedConfig);
