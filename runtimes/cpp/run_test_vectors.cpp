...
int main() {
  ...
  const DecisionInput hysteresisHold{25.7F, 6000UL, 0.0F, 0UL, "hot"};
  ...
  const DecisionInput hysteresisNoHoldPreviousState{25.7F, 7000UL, 0.0F, 0UL, "normal"};
  ...
  const DecisionInput hysteresisNoHoldThreshold{25.4F, 8000UL, 0.0F, 0UL, "hot"};
  ...
  const DecisionInput rateGtMatch{25.3F, 9000UL, 25.1F, 0UL, ""};
  ...
  const DecisionInput rateGtBoundary{25.2F, 10000UL, 25.1F, 0UL, ""};
  ...
  const DecisionInput rateGtNegative{25.1F, 11000UL, 25.3F, 0UL, ""};
  ...
  const DecisionInput rateLtMatch{25.1F, 12000UL, 25.3F, 0UL, ""};
  ...
  const DecisionInput rateLtBoundary{25.2F, 13000UL, 25.3F, 0UL, ""};
  ...
  const DecisionInput rateLtPositive{25.3F, 14000UL, 25.1F, 0UL, ""};
  ...
  const DecisionInput stateEscalationMatch{26.1F, 15000UL, 26.0F, 5000UL, "hot"};
  ...
  const DecisionInput stateEscalationShortDuration{26.1F, 16000UL, 26.0F, 4999UL, "hot"};
  ...
  const DecisionInput stateEscalationDifferentPreviousState{26.1F, 17000UL, 26.0F, 5000UL, "warming"};
  ...
  const DecisionInput stateEscalationBaseNormal{25.0F, 18000UL, 26.0F, 5000UL, "hot"};
