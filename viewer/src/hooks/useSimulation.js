...
import { buildTimelineRows, createEmptyTimelineState, parseSequenceText } from "../lib/viewerTimelineWorkflow.js";
...
export function useSimulation() {
  ...
  function resetTimelinePlayback() {
    ...
    const emptyState = createEmptyTimelineState();
    setTimelineRows(emptyState.timelineRows);
    setTimelineDomainRows(emptyState.timelineDomainRows);
    setTimelineError(emptyState.timelineError);
  }
